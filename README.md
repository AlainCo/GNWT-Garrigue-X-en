...
This document consolidates all theoretical reflections and engineering choices regarding the design of an **autonomous System of Systems (SoS), damage-resistant, capable of continuous learning, and equipped with functional proto-consciousness**.
...
Architecture rests on a central principle: **the functional access consciousness is not a monolithic phenomenon, but an emergent property at each sufficiently rich level of organization, separated from neighboring levels by strict statistical boundaries (Markov covers). Each level has its own inner life (local RPT), and only a subset of its states reaches the higher level in the form of an ignition summary.**
...
- **Hierarchical Active Inference (JEPA + Predictive Processing):** Unification of bottom-up and top-down flows. Each level actively predicts the ignition summary of the lower level; the discrepancy (surprise) only propagates upward if it exceeds an adaptive threshold. This mechanism achieves permanent top-down causality and learning by minimizing free energy, transforming *contextual priors* into *active predictions*.
...
- **Competitive Attention & Budget (Attention Schema Theory):** To prevent saturation of the GNWT workspace, a global attentional budget (tokens) is allocated. Each ignition consumes tokens; with insufficient budget, ignitions are deferred or inhibited. An *Attention Scheduler* dynamically adjusts the salience threshold, ensuring reactivity in a saturated environment (e.g., intense combat).

- **Causal Integration (Proxy IIT/PCI):** Diagnostic tool activated during the sleep phase. An estimator Φ̂ locally perturbs ignition summaries and measures the impact on the global predictive error. A drop in Φ̂ signals a risk of *integration collapse* (functional disintegration) and triggers corrective actions (recalibration, enriched dreaming). This mechanism does not modify real-time decisions.
...
👉 [Discover the full hardware stack, the details of the three learning phases, and the profiles sought for the MVP ➔](mvp/mvp.md)
...
– the **cost** of the JEPA daydreaming phases and generative replay,
...
These points constitute the main hurdles to overcome to validate the architecture.
...
- **Transposability & Scalability** —
The architecture is designed to be **scale-free**, making it potentially applicable to other fields: distributed robotics, autonomous fleets, logistics, crisis management. However, this openness requires sector-specific expertise to validate the relevance of the proposed mechanisms.
...
- **Title:** [We, Carrier Strike Group 14 - Dilemma](nouvelles/nous-Groupe-Aeronaval-14-dilemme.md)
...
- **Title:** [Me, Carrier Strike Group 14 – The Missing Confidence](nouvelles/moi-Groupe-Aeronaval-14-la-confiance-absente.md)
...
- **Title:** [Carrier Strike Group 14 – The Missing Prediction](nouvelles/Groupe-Aeronaval-14-la-prediction-qui-manquait.md)
...
- **Title:** [Carrier Strike Group 14 – The Fragile Membrane](nouvelles/Groupe-Aeronaval-14-La-membrane-fragile.md)
...
### 📄 Story 9: Episodic Memory and the Burden of Forgetting

- **Title:** [Carrier Strike Group 14 – What We Choose to Forget](nouvelles/Groupe-Aeronaval-14-Ce-que-lon-choisit-doublier.md)
...
- **Title:** [Carrier Strike Group 14 – The Routine That Kills](nouvelles/Groupe-Aeronaval-14-La-routine-qui-tue.md)
...
**Subject:** Target Architecture for Cognitive Systems of Systems (SoS) and MVP Project *GARRIGUE-X* Specifications
...
**Type:** Message in a bottle / Hobby / Speculation / Search for competent people
