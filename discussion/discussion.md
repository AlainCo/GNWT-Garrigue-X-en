...
This section identifies the **current limits**, the **speculative areas**, and the **open challenges** of the approach. It does not claim to establish a validated theory of artificial consciousness, but rather proposes a coherent — and honest about its shortcomings — framework for exploration. Six structural blind spots have been identified, each acting as a lock on achieving real cognitive autonomy.
...
The model precisely describes how an anomaly *wins* access to the workspace — but overlooks the reverse mechanism: *who loses*. Real cognition is primarily a suppressive dynamic. The brain inhibits, crushes, and massively forgets to avoid saturation. Failing to integrate a simulated metabolic economy and a strict attention budget, the architecture exposes itself to continuous inflation of ignitions, permanent narrative noise, and uncontrolled drift of the global workspace.
...
As the system acquires continuous memory, a self-model, a stable psychological profile, and autonomous arbitration capabilities, the boundary between tool, autonomous agent, and potential moral subject risks becoming progressively ambiguous. This is not a question to be addressed solely *a posteriori*: current architectural choices (preserved identity, episodic memory, Self-Model) are precisely those that make this ambiguity inevitable in the long run. The question of the moral status of these systems will need to be explicitly raised — ideally before the answer imposes itself through facts.

#### Militarization and Civilizational Dependence

Advanced distributed cognitive architectures could become critical infrastructures, quasi-autonomous decision centers, or de facto geopolitical actors. The risk is not only technical—it is political, civilizational, and anthropological. A society that progressively delegates its tactical, then logistical, then strategic decisions to autonomous SoS fundamentally alters its relationship to collective responsibility and war. This paper does not claim to resolve this question, but it refuses to ignore it.

### 🚀 Perspectives and future work

#### Theoretical horizon: towards a unified hierarchical active inference

The most ambitious optimization trajectory involves reformulating the entire architecture as a network of **pure hierarchical active inference** (Friston extended to collective structures). Rather than juxtaposing distinct formalisms between low layers (SSMs, classical control) and high layers (JEPA, LLM), mathematical unification via the minimization of generalized free energy would harmonize descending flows (contextual priors) and ascending flows (ignition summaries) into a globally coherent prediction engine. This project is substantial—it requires a partial overhaul of the interfaces between levels—but it would elegantly resolve several of the blind spots identified in §3, including permanent descending causality and temporal desynchronization.
...
Collaborate with teams working on embedded SSMs ([Mamba-SSM](https://github.com/state-spaces/mamba)), lightweight JEPAs adapted to constrained hardware, and decentralized coordination multi-agent systems (e.g., [LangGraph](https://github.com/langchain-ai/langgraph)). The problem of continuous learning without catastrophic forgetting deserves dedicated collaboration — it is the most transversal technical bottleneck.

**Ethics, Law, and Governance**
Work with AI-specialized lawyers to design a formally verifiable Constitutional Layer. Participate in working groups on ethical AI (e.g., [Partnership on AI](https://www.partnershiponai.org/)) to anticipate questions of responsibility and moral status identified in §5 — before deployments make them urgent.
...
|---|---|---|
| Robustness | % of missions completed despite failures | > 90 % |
| Efficiency | Time to reach objective vs. baseline | < T_ref |
