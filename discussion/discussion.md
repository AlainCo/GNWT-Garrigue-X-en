...
This gap has a concrete consequence on the management of distributed identities: excessive sharing of internal states between agents could lead to self-dissolution, bias or trauma propagation, and loss of specialization. Mechanisms of partial isolation, strictly private memory, and limited synchronization will likely be necessary — and remain to be entirely designed.
...
Collaborate with teams working on embedded SSMs ([Mamba-SSM](https://github.com/state-spaces/mamba)), lightweight JEPA adapted to constrained hardware, and decentralized multi-agent systems (e.g., [LangGraph](https://github.com/langchain-ai/langgraph)). The problem of continuous learning without catastrophic forgetting deserves dedicated collaboration — it is the most cross-cutting technical bottleneck.
