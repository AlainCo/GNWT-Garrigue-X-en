...
Beyond its technical contributions, this work takes a stand in a broader debate on the nature of distributed cognition and the conditions for the emergence of functional artificial consciousness. Three major theoretical convergences deserve to be explained.
...
#### 2. The competitive and inhibitory attention deficit

The model precisely describes how an anomaly *gains* access to the workspace — but overlooks the reverse mechanism: *who loses*. Real cognition is primarily a suppressive dynamic. The brain inhibits, crushes, and massively forgets to avoid saturation. Failing to integrate a simulated metabolic economy and a strict attention budget, the architecture exposes itself to continuous inflation of ignitions, permanent narrative noise, and uncontrolled drift of the global workspace.
...
Add the global workspace with JEPA-M and a first simplified version of MeMo (episodic memory v1). Objective: test the complete learning cycle Mission → Daydream and measure memory consolidation between sessions.
