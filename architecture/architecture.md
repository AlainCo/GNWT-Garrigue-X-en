...
During the sleep phase, an estimator Φ̂ (a proxy for causal integration) is periodically calculated from the stored ignition summaries. A drop in Φ̂ indicates a risk of functional disintegration and triggers corrective mechanisms (recalibration, enriched dreaming).
